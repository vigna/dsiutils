 ...
 * DSI utilities
 *
 * Copyright (C) 2022-2026 Sebastiano Vigna
 *
...
public class BenchmarkXoRoShiRo128PlusPlus {

    private it.unimi.dsi.util.XoRoShiRo128PlusPlusRandomGenerator random;

    @Setup(Level.Trial)
    public void doSetup() {
        random = new it.unimi.dsi.util.XoRoShiRo128PlusPlusRandomGenerator();
    }
