...
public class BenchmarkXoRoShiRo128StarStar {

    private it.unimi.dsi.util.XoRoShiRo128StarStarRandomGenerator random;

    @Setup(Level.Trial)
    public void doSetup() {
        random = new it.unimi.dsi.util.XoRoShiRo128StarStarRandomGenerator();
    }
