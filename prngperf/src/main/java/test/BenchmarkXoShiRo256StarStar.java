...
public class BenchmarkXoShiRo256StarStar {

    private it.unimi.dsi.util.XoShiRo256StarStarRandomGenerator random;

    @Setup(Level.Trial)
    public void doSetup() {
        random = new it.unimi.dsi.util.XoShiRo256StarStarRandomGenerator();
    }
