...
public class BenchmarkXorShift1024StarPhi {

    private it.unimi.dsi.util.XorShift1024StarPhiRandomGenerator random;

    @Setup(Level.Trial)
    public void doSetup() {
        random = new it.unimi.dsi.util.XorShift1024StarPhiRandomGenerator();
    }
