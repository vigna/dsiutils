 ...
 * @see RandomGenerator
 * @see XoRoShiRo128PlusPlusRandomGenerator
 */
...
public class XoRoShiRo128PlusPlusRandom extends Random {
	...
	protected XoRoShiRo128PlusPlusRandom(final long s0, final long s1) {
		this.s0 = s0;
		this.s1 = s1;
	}
	 ...
	 */
	public XoRoShiRo128PlusPlusRandom(final long seed) {
		setSeed(seed);
	}
	...
	public XoRoShiRo128PlusPlusRandom copy() {
		return new XoRoShiRo128PlusPlusRandom(s0, s1);
	}
