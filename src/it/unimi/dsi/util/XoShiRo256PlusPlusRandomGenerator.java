 ...
 * @see RandomGenerator
 * @see XoShiRo256PlusPlusRandom
 */

public class XoShiRo256PlusPlusRandomGenerator extends AbstractRandomGenerator implements Serializable {
	private static final long serialVersionUID = 0L;
	/** The internal state of the algorithm. */
	private long s0, s1, s2, s3;

	protected XoShiRo256PlusPlusRandomGenerator(final long s0, final long s1, final long s2, final long s3) {
		this.s0 = s0;
		this.s1 = s1;
		this.s2 = s2;
		this.s3 = s3;
	 ...
	 */
	public XoShiRo256PlusPlusRandomGenerator(final long seed) {
		setSeed(seed);
	}
	 ...
	 */
	public XoShiRo256PlusPlusRandomGenerator copy() {
		return new XoShiRo256PlusPlusRandomGenerator(s0, s1, s2, s3);
	}
	...
	protected XoShiRo256PlusPlusRandomGenerator jump(final long[] jump) {
		long s0 = 0;
		long s1 = 0;
		long s2 = 0;
		long s3 = 0;
	...
	public XoShiRo256PlusPlusRandomGenerator split() {
		nextLong();
		final XoShiRo256PlusPlusRandomGenerator split = copy();
