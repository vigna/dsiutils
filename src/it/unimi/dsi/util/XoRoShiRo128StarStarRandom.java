 ...
 * In Java, it is slightly slower than a {@link XoRoShiRo128PlusPlusRandom}.
 ...
 * @see RandomGenerator
 * @see XoRoShiRo128StarStarRandomGenerator
 */
...
public class XoRoShiRo128StarStarRandom extends Random {
	...
	protected XoRoShiRo128StarStarRandom jump(final long[] jump) {
		long s0 = 0;
		long s1 = 0;
	...
	public XoRoShiRo128StarStarRandom split() {
		nextLong();
		final XoRoShiRo128StarStarRandom split = copy();
	...
	public static void main(final String[] arg) {
		...
		final XoRoShiRo128StarStarRandom r = new XoRoShiRo128StarStarRandom(0);
		for(int k = 10; k-- != 0;) {
			pl.start("Measuring...");
			for (long i = n; i-- != 0;)
				x ^= r.nextLong();
