 ...
 * use {@link XoRoShiRo128StarStarRandomGenerator} or {@link XoShiRo256PlusRandomGenerator}.
 ...
 *
 * <p>If you need a general PRNG, use {@link XoRoShiRo128StarStarRandomGenerator}. If you can use more space,
 * you might try {@link XoShiRo256PlusRandomGenerator}.
 *
 ...
 * This class provides also a {@link #split()} method to support recursive parallel computations, in the spirit of
...
public class XoRoShiRo128PlusRandomGenerator extends AbstractRandomGenerator implements Serializable {
	...
	protected XoRoShiRo128PlusRandomGenerator(final long s0, final long s1) {
		this.s0 = s0;
		this.s1 = s1;
	}
	...
	public XoRoShiRo128PlusRandomGenerator copy() {
		return new XoRoShiRo128PlusRandomGenerator(s0, s1);
	}
	...
	protected XoRoShiRo128PlusRandomGenerator jump(final long[] jump) {
		long s0 = 0;
		long s1 = 0;
	...
	public XoRoShiRo128PlusRandomGenerator split() {
		nextLong();
		final XoRoShiRo128PlusRandomGenerator split = copy();
