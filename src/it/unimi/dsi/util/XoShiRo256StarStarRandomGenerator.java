...
public class XoShiRo256StarStarRandomGenerator extends AbstractRandomGenerator implements Serializable {
	...
	protected XoShiRo256StarStarRandomGenerator(final long s0, final long s1, final long s2, final long s3) {
		this.s0 = s0;
		this.s1 = s1;
		this.s2 = s2;
		this.s3 = s3;
	 ...
	 */
	public XoShiRo256StarStarRandomGenerator copy() {
		return new XoShiRo256StarStarRandomGenerator(s0, s1, s2, s3);
	}
	...
	protected XoShiRo256StarStarRandomGenerator jump(final long[] jump) {
		long s0 = 0;
		long s1 = 0;
		long s2 = 0;
		long s3 = 0;
	...
	public XoShiRo256StarStarRandomGenerator split() {
		nextLong();
		final XoShiRo256StarStarRandomGenerator split = copy();
