 ...
 * In Java, it is slightly slower than a {@link XoShiRo256PlusPlusRandom}.
...
public class XoShiRo256StarStarRandom extends Random {
	...
	protected XoShiRo256StarStarRandom(final long s0, final long s1, final long s2, final long s3) {
		this.s0 = s0;
		this.s1 = s1;
		this.s2 = s2;
		this.s3 = s3;
	...
	public XoShiRo256StarStarRandom copy() {
		return new XoShiRo256StarStarRandom(s0, s1, s2, s3);
	}
	...
	protected XoShiRo256StarStarRandom jump(final long[] jump) {
		long s0 = 0;
		long s1 = 0;
		long s2 = 0;
		long s3 = 0;
	...
	public XoShiRo256StarStarRandom split() {
		nextLong();
		final XoShiRo256StarStarRandom split = copy();
