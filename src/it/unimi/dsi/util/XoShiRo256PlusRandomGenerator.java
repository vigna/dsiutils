...
/** A fast, rock-solid {@linkplain RandomGenerator pseudorandom number generator} for floating-point generation.
 * It has excellent speed, a state space (256 bits) that is large enough for
 * any parallel application, and it is faster than {@link XoShiRo256StarStarRandomGenerator}. It passes all
 ...
 *
 * <p>If you need a general PRNG, use {@link XoShiRo256StarStarRandomGenerator}. If you are tight on space,
 * you might try {@link XoRoShiRo128PlusRandomGenerator}.
 *
...
public class XoShiRo256PlusRandomGenerator extends AbstractRandomGenerator implements Serializable {
	...
	protected XoShiRo256PlusRandomGenerator(final long s0, final long s1, final long s2, final long s3) {
		this.s0 = s0;
		this.s1 = s1;
		this.s2 = s2;
		this.s3 = s3;
	 ...
	 */
	public XoShiRo256PlusRandomGenerator(final long seed) {
		setSeed(seed);
	}
	...
	public XoShiRo256PlusRandomGenerator copy() {
		return new XoShiRo256PlusRandomGenerator(s0, s1, s2, s3);
	}
	...
	protected XoShiRo256PlusRandomGenerator jump(final long[] jump) {
		long s0 = 0;
		long s1 = 0;
		long s2 = 0;
		long s3 = 0;
	...
	public XoShiRo256PlusRandomGenerator split() {
		nextLong();
		final XoShiRo256PlusRandomGenerator split = copy();
