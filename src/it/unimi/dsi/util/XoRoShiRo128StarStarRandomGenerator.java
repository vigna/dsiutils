 ...
 * In Java, it is slightly slower than a {@link XoRoShiRo128PlusPlusRandomGenerator}.
 ...
 * you might try {@link XoShiRo256StarStarRandomGenerator}.
 *
 ...
 * @see Random
 * @see XoRoShiRo128StarStarRandom
 */

public class XoRoShiRo128StarStarRandomGenerator extends AbstractRandomGenerator implements Serializable {
	private static final long serialVersionUID = 0L;
	/** The internal state of the algorithm. */
	private long s0, s1;

	protected XoRoShiRo128StarStarRandomGenerator(final long s0, final long s1) {
		this.s0 = s0;
		this.s1 = s1;
	}
	 ...
	 */
	public XoRoShiRo128StarStarRandomGenerator(final long seed) {
		setSeed(seed);
	}
	...
	public XoRoShiRo128StarStarRandomGenerator copy() {
		return new XoRoShiRo128StarStarRandomGenerator(s0, s1);
	}
	...
	protected XoRoShiRo128StarStarRandomGenerator jump(final long[] jump) {
		long s0 = 0;
		long s1 = 0;
	...
	public XoRoShiRo128StarStarRandomGenerator split() {
		nextLong();
		final XoRoShiRo128StarStarRandomGenerator split = copy();
	...
	public static void main(final String[] arg) {
		...
		final XoRoShiRo128StarStarRandomGenerator r = new XoRoShiRo128StarStarRandomGenerator(0);
		for(int k = 10; k-- != 0;) {
			pl.start("Measuring...");
			for (long i = n; i-- != 0;)
				x ^= r.nextLong();
