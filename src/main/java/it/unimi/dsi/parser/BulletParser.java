 ...
 * internal maps are {@linkplain Reference2ObjectMap reference-based
 ...
 *
 * <p>
 * The bullet parser uses attributes and methods of {@link HTMLFactory},
 * {@link Element}, {@link Attribute} and
 * {@link Entity}. Thus, for instance, whenever an element is to be passed
 * around it is one of the shared objects contained in {@link Element} (e.g.,
 * {@link Element#BODY}).
 *
 * <h2>Callbacks</h2>
 *
 ...
 * {@linkplain Callback callback interface} of the bullet parser
 * remembers closely SAX2, but it has some additional methods targeted at (X)HTML, such as
 * {@link Callback#cdata(Element,char[],int,int)},
 ...
 * {@link Callback#characters(char[], int, int, boolean)} method for
 ...
 * {@link Callback#cdata(Element,char[],int,int)} method for every
 * CDATA section found.
 * </ul>
 *
