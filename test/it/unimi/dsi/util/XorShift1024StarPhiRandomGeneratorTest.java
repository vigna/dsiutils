 ...
 * DSI utilities
 *
 * Copyright (C) 2013-2026 Sebastiano Vigna
 *
...
public class XorShift1024StarPhiRandomGeneratorTest {
	private final static long seeds[] = { 0, 1, 1024, 0x5555555555555555L };

	@Test
	public void testNextFloat() {
		for (final long seed : seeds) {
			final XorShift1024StarPhiRandomGenerator xorShift = new XorShift1024StarPhiRandomGenerator(seed);
			double avg = 0;
	...
	public void testNextDoubleFast() {
		for (final long seed : seeds) {
			...
			double avg = 0;
			for (int i = 1000000; i-- != 0;) {
				final double d = xorShift.nextDoubleFast();
				assertTrue(d < 1);
				assertTrue(d >= 0);
				avg += d;
			}
	...
	public void testNextInt() {
		for (final long seed : seeds) {
			...
			assertEquals(5000000000L, avg, 600000);
		}
	}
	...
	public void testNextInt3() {
		final XorShift1024StarPhiRandomGenerator xorShiftRandom = new XorShift1024StarPhiRandomGenerator(0);
		for(int i = 0; i < 100; i++) assertTrue(xorShiftRandom.nextInt(16) < 16);
	}

	@Test
	public void testNextInt4() {
		final XorShift1024StarPhiRandomGenerator xorShift = new XorShift1024StarPhiRandomGenerator(0);
	...
	public void testSameAsRandom() {
		final XorShift1024StarPhiRandom xorShiftStarRandom = new XorShift1024StarPhiRandom(0);
		final XorShift1024StarPhiRandomGenerator xorShiftStar = new XorShift1024StarPhiRandomGenerator(0);
		for(int i = 1000000; i-- != 0;) {
	...
	public void testJump() {
		final XorShift1024StarPhiRandomGenerator xorShiftRandom0 = new XorShift1024StarPhiRandomGenerator(0), xorShiftRandom1 = new XorShift1024StarPhiRandomGenerator(0);
