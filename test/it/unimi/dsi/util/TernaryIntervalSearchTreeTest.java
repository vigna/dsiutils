...
public class TernaryIntervalSearchTreeTest {
	...
	private void assertContains(final TernaryIntervalSearchTree t , final String s, final int i) {
	...
	public void testSingleString() {
		final TernaryIntervalSearchTree t = new TernaryIntervalSearchTree();
		t.add("test");
	...
	public void test() {
		...
		for (final String element : WORDS)
			assertTrue(element, t.containsKey(element));
